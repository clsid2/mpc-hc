...
void CPPageAdvanced::InitSettings()
{
    ...
    addComboItem(TIME_ON_SEEKBAR, IDS_RS_TIME_ON_SEEKBAR, TIME_ON_SEEKBAR_NEVER, s.nTimeOnSeekBar,
                 { ResStr(IDS_TIME_ON_SEEKBAR_NEVER), ResStr(IDS_TIME_ON_SEEKBAR_ALWAYS), ResStr(IDS_TIME_ON_SEEKBAR_WHEN_STATUSBAR_HIDDEN) },
                 StrRes(IDS_PPAGEADVANCED_TIME_ON_SEEKBAR));
