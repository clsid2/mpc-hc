...
#define IDS_RS_REPLAYGAINMODE               _T("ReplayGainMode")
#define IDS_RS_REPLAYGAINPREAMP             _T("ReplayGainPreamp")
#define IDS_RS_REPLAYGAINPREVENTCLIPPING    _T("ReplayGainPreventClipping")
