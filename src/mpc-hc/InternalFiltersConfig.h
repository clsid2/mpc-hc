...
#define INTERNAL_SOURCEFILTER_APE       INTERNAL_FILTERS_LAV
...
#define INTERNAL_DECODER_AC4            INTERNAL_FILTERS_LAV
...
#define INTERNAL_DECODER_CFHD           INTERNAL_FILTERS_LAV
