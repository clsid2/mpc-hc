...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --x86asmexe=nasm --pkg-config-flags=--static --extra-cflags='-D_WIN32_WINNT=0x0601 -DWINVER=0x0601 -Zo -GS- -MD' --extra-ldflags=' -NODEFAULTLIB:libcmt' --enable-shared --disable-static --enable-gpl --enable-version3 --disable-autodetect --enable-w32threads --disable-demuxer=matroska --disable-filters --enable-filter='scale,yadif,w3fdif,bwdif' --disable-protocol='async,cache,concat,httpproxy,icecast,md5,subfile' --disable-muxers --enable-muxer=spdif --disable-bsfs --enable-bsf='extract_extradata,dovi_split' --disable-avdevice --disable-encoders --disable-devices --disable-programs --disable-doc --enable-avisynth --enable-d3d11va --enable-dxva2 --enable-zlib --build-suffix=-lav --disable-stripping --disable-debug --enable-schannel --enable-bzlib --enable-libdav1d --enable-libspeex --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libxml2 --arch=x86_64"
