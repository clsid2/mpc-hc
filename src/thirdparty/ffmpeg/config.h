...
#define HAVE_X86_6REGS 0
#define HAVE_X86_7REGS 0
...
#define HAVE_DXVA_PICPARAMS_HEVC_RANGEEXT 1
...
#define CONFIG_LIBONNXRUNTIME 0
...
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.51.36252 for x64"
#define EXTERN_ASM 
#define EXTERN_PREFIX ""
#define FFMPEG_CONFIGURATION "--toolchain=msvc --x86asmexe=nasm --enable-gpl --enable-version3 --enable-w32threads --enable-static --enable-libsoxr --disable-shared --disable-everything --disable-mediafoundation --disable-schannel --disable-dxva2 --disable-d3d11va --disable-d3d12va --disable-vulkan --disable-autodetect --disable-programs --disable-doc --disable-avdevice --disable-devices --disable-swscale --enable-avformat --enable-encoder='ac3,eac3' --enable-muxer='mp4,mov' --enable-protocol=file --enable-filter='abuffer,abuffersink,atempo,aresample' --arch=x86_64 --extra-cflags='-I../../../LAVFilters/src/thirdparty/64/include -I../../../zlib -I../../../soxr/libsoxr/src' --extra-ldflags='-LIBPATH:../../../LAVFilters/src/thirdparty/64/lib -LIBPATH:../../../../../bin/lib/Release_x64'"
...
#define CC_IDENT "Microsoft (R) C/C++ Optimizing Compiler Version 19.51.36252 for x86"
#define EXTERN_ASM _
#define EXTERN_PREFIX "_"
#define FFMPEG_CONFIGURATION "--toolchain=msvc --x86asmexe=nasm --enable-gpl --enable-version3 --enable-w32threads --enable-static --enable-libsoxr --disable-shared --disable-everything --disable-mediafoundation --disable-schannel --disable-dxva2 --disable-d3d11va --disable-d3d12va --disable-vulkan --disable-autodetect --disable-programs --disable-doc --disable-avdevice --disable-devices --disable-swscale --enable-avformat --enable-encoder='ac3,eac3' --enable-muxer='mp4,mov' --enable-protocol=file --enable-filter='abuffer,abuffersink,atempo,aresample' --arch=x86 --extra-cflags='-I../../../LAVFilters/src/thirdparty/32/include -I../../../zlib -I../../../soxr/libsoxr/src' --extra-ldflags='-LIBPATH:../../../LAVFilters/src/thirdparty/32/lib -LIBPATH:../../../../../bin/lib/Release_Win32'"
