...
#define CONFIG_DOVI_SPLIT_BSF 0
...
#define CONFIG_PCM_DVDA_DECODER 0
...
#define CONFIG_H264_MVC_PARSER 0
...
#define CONFIG_MATROSKA_HAALI_DEMUXER 0
...
#define CONFIG_WEBP_ANIM_DEMUXER 0
